...
const addressData = require('../lib/En/adress');
...
const personData = require('../lib/En/person');
const productData = require('../lib/En/product');
const vehicleData = require('../lib/En/vehicle');
