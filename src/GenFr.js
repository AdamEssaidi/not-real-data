...
const addressData = require('../lib/Fr/adress');
const animalData = require('../lib/Fr/animal');
const bookData = require('../lib/Fr/book');
const colorData = require('../lib/Fr/color');
const foodData = require('../lib/Fr/food');
const holidayData = require('../lib/Fr/holiday');
const movieData = require('../lib/Fr/movie');
const personData = require('../lib/Fr/person');
const productData = require('../lib/Fr/product');
const vehicleData = require('../lib/Fr/vehicle');
const companiesData = require('../lib/Fr/company');
